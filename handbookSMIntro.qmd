---
title: "The DSP Program Handbook for Statistical Modelling"
---
...
As biologists, the variability that you are interested in relates to the biological world, but your job (explaining variability) is really no different from other scientists/researchers/data analysts, etc. - you are all explaining variability.
...
Your job then is to explain observation variability in time and space by creating a "model" of what (you think) is going on - hence statistical modelling. This is your best guess of how the world is your hypothesis in mathematical form.  Then you can use statistics to evaluate how useful that "best guess" is  modelling actually let's you accomplish two tasks (this is testing your hypothesis).  
...
#### [Response(s)](DSPH_SM_Responses.qmd)
...
#### [Predictor(s)](DSPH_SM_Predictors.qmd) 
...
#### [Hypothesis](DSPH_SM_Hypothesis.qmd)
...
#### [Starting model](DSPH_SM_StartingModel)
...
#### [Model validation](DSPH_SM_ModelValidation.qmd) 
...
#### [Hypothesis testing](DSPH_SM_HypothesisTesting.qmd)
...
#### [Reporting](DSPH_SM_Reporting.qmd)
...
#### [Predicting](DSPH_SM_Predicting.qmd)
