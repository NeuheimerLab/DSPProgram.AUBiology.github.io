...
As we discussed before "All models are wrong, but some are useful".  So how do you tell if your [starting model](DSPPH_SM_ModelValidation.qmd) is a useful one; that is, one that can be used to test your hypothesis? 
...
# 
# library(DHARMa)
# simOut <- simulateResiduals(fittedModel = startMod, n = 250) # simulate data from our model n times
# 
# plot(simOut, asFactor=FALSE) # compare simulated data to our observations
# 
# library(MuMIn)
