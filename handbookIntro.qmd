...
The DSP Program Handbook contains information on the DSP Program (see ###) as well as resources for data collection, analysis and statistical modelling tasks.
...
If you find yourself needing a more general purpose language, try [Python](https://www.python.org/) or [Julia](https://julialang.org/).  
